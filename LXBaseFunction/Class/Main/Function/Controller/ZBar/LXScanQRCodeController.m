...
@interface LXScanQRCodeController ()<ZBarReaderViewDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    ZBarReaderView *_readview;//扫描二维码ZBarReaderView
    LXQRCodeView *_qrRectView;//自定义的扫描视图
...
@implementation LXScanQRCodeController
...
- (void)configuredZBarReaderMaskView{
    //扫描的矩形方框视图
    _qrRectView = [[LXQRCodeView alloc] init];
    ...
    _lightingBtn.layer.borderColor = [UIColor blueColor].CGColor;
    ...
    lightImage.image = [UIImage imageNamed:@"iOS-O2O-icon_icon-bulb"];
    ...
    [_importQRCodeImage setBackgroundImage:[UIImage imageNamed:@"iOS-O2O-icon_hand-album"] forState:UIControlStateNormal];
